...
import com.example.projet.MapActivity;
...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       TextView textView4=myView.findViewById(R.id.textView4);

       MapActivity temp=(MapActivity)getActivity();
        temp.setTitle(temp.OACI);
        textView2.setText(temp.TafCode);
        textView4.setText(temp.MetarCode);
